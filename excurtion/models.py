...
class Excurtion(models.Model):
    ...
    photo = models.ImageField(_("Foto"),upload_to="media/img/excurtion")

    photo_2 = models.ImageField(_("Foto Post Excursion I"),blank=True,upload_to="media/img/excurtion")
    photo_3 = models.ImageField(_("Foto Post Excursion II"),blank=True,upload_to="media/img/excurtion")
    photo_4 = models.ImageField(_("Foto Post Excursion III"),blank=True,upload_to="media/img/excurtion")
    photo_5 = models.ImageField(_("Foto Post Excursion IV"),blank=True,upload_to="media/img/excurtion")
    photo_6 = models.ImageField(_("Foto Post Excursion V"),blank=True,upload_to="media/img/excurtion")
